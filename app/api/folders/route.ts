...
const defaultFolders = [
  ...
  { slug: 'uburezi', name: 'Uburezi', nameEn: 'Education', description: 'Ibigiriro byo kugutsinda mu nzira', descriptionEn: 'Educational content to help you succeed', image: '/images/uburezi.jpg', color: 'from-blue-400 to-cyan-500', order: 4, type: 'video' },
  { slug: 'abana-1-5', name: "Videwo z'Abana 1-5", nameEn: 'Kids 1-5 Years', description: 'Ibigiriro byiza kuri abana ba miaka 1-5', descriptionEn: 'Great videos for toddlers aged 1-5', image: '/images/abana_television.jpg', color: 'from-purple-400 to-pink-500', order: 5, type: 'video' },
  { slug: 'abana-5-14', name: "Videwo z'Abana 5-14", nameEn: 'Kids 5-14 Years', description: 'Ibigiriro byiza kuri abana ba miaka 5-14', descriptionEn: 'Engaging content for kids aged 5-14', image: '/images/abana_5_14_television.jpg', color: 'from-indigo-400 to-blue-500', order: 6, type: 'video' },

  // Short Film folders
  { slug: 'ubuzima', name: 'Ubuzima', nameEn: 'Life & Living', description: "Imibereho yo murugo nuko umwana yitara", descriptionEn: 'Daily life routines and behaviors', image: '/images/ubuzima.jpg', color: 'from-emerald-400 to-teal-500', order: 1, type: 'short-film' },
  ...
  { slug: 'uburezi-films', name: 'Uburezi', nameEn: 'Educational Films', description: "Uko umwana yiga mu rugo akanezererwa", descriptionEn: 'Fun educational activities at home', image: '/images/uburezi.jpg', color: 'from-blue-400 to-indigo-500', order: 4, type: 'short-film' },
  { slug: 'abana-1-5-films', name: "Film z'Abana 1-5", nameEn: 'Films for Kids 1-5', description: "Filime zishimishije z'abana bato ba miaka 1-5", descriptionEn: 'Entertaining short films for kids 1-5', image: '/images/abana_television.jpg', color: 'from-pink-400 to-rose-500', order: 5, type: 'short-film' },
  { slug: 'abana-5-14-films', name: "Videwo z'Abana 5-14", nameEn: 'Videos for Kids 5-14', description: "Videwo n'amafilime by'abana ba miaka 5-14", descriptionEn: 'Great short films for kids aged 5-14', image: '/images/abana_5_14_television.jpg', color: 'from-violet-400 to-purple-500', order: 6, type: 'short-film' },
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { name, nameEn, description, descriptionEn, image, color, slug, type } = body

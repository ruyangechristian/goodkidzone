...
const defaultFolders: Omit<FolderDoc, '_id'>[] = [
  ...
  { slug: 'abana-5-14', name: "Videwo z'Abana 5-14", nameEn: 'Kids 5-14 Years', description: 'Ibigiriro byiza kuri abana ba miaka 5-14', descriptionEn: 'Engaging content for kids aged 5-14', image: '/images/abana_television.jpg', color: 'from-indigo-400 to-blue-500', order: 6, type: 'video' },
  ...
  { slug: 'abana-5-14-films', name: "Videwo z'Abana 5-14", nameEn: 'Videos for Kids 5-14', description: "Videwo n'amafilime by'abana ba miaka 5-14", descriptionEn: 'Great short films for kids aged 5-14', image: '/images/abana_television.jpg', color: 'from-violet-400 to-purple-500', order: 6, type: 'short-film' },
